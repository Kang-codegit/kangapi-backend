...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        // 判断该接口是否可以调用
        com.kangapi.kangapiclientsdk.model.User user = new com.kangapi.kangapiclientsdk.model.User();
        user.setUsername("test");
        String username = kangApiClient.getUsernameByPost(user);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        Gson gson = new Gson();
        com.kangapi.kangapiclientsdk.model.User user = gson.fromJson(userRequestParams, com.kangapi.kangapiclientsdk.model.User.class);
